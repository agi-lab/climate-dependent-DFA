...
plot(x = start_year_proj:(start_year_proj + horizon - 1), y = gross_premium_CAT_norm_mat[1:horizon, 1], type = "l", col = col_list[1], xlab = "Years", ylab = "Premiums", main = "Gross CAT premiums (normalised)", ylim = c(4e9, 9e9), cex.main = 1.5, cex.lab = 1.5, cex.axis = 1.5, lwd = 4)
for(s in 2:4){
...
horizon <- 38
plot(x = start_year:(start_year+horizon - 1), y = premium_re_quantiles_list_cycle_norm[[1]][2, 1:horizon], type = "l", col = col_list[1], ylim = c(5e8, 2.5e9), xlab = "Years", ylab = "Reinsurance premium", main = "Reinsurance premiums (normalised; mean)", cex.main = 1.5, cex.lab = 1.5, cex.axis = 1.5, lwd = 4)
for(s in 2:4){
...
legend("topleft", legend = c("SSP 2.6", "SSP 4.5", "SSP 7.0", "SSP 8.5"), col = col_list, cex = 0.8, lty = c(1,1,1,1), lwd = rep(4, 4))
#dev.off()
```
...
legend("topleft", legend = c("SSP 2.6", "SSP 4.5", "SSP 7.0", "SSP 8.5"), col = col_list, cex = 1, lty = c(1,1,1,1), lwd = rep(3, 4))
#dev.off()
```
...
horizon <- 38
plot(x = start_year:(start_year + horizon - 1), y = log(market_capital_adj_median_cycle[1:horizon, 1]), col = col_list[1], type = "l", xlab = "Years", ylab = "Median surplus", main = "Median market surplus (log-scale)", ylim = c(25, 32), lwd = 4, cex.main = 1.5, cex.lab = 1.5, cex.axis = 1.5)
for(s in 2:4){
...
plot(x = start_year:(start_year + horizon - 1), y = log(market_capital_adj_quantiles_list_cycle[[1]][2, 1:horizon]), col = col_list[1], type = "l", xlab = "Years", ylab = "Mean surplus", main = "Mean market surplus (log-scale)", ylim = c(25, 32), lwd = 4, cex.main = 1.5, cex.lab = 1.5, cex.axis = 1.5)
for(s in 2:4){
...
legend("topleft", legend = c("SSP 2.6", "SSP 4.5", "SSP 7.0", "SSP 8.5"), col = col_list, cex = 0.9, lty = c(1,1,1,1), lwd = rep(4, 4))
